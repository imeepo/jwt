...
use imeepo\Jwt\Exception\JwtCacheTokenException;
use imeepo\Jwt\Exception\JwtRefreshTokenExpiredException;
use imeepo\Jwt\Exception\JwtTokenException;
use imeepo\Jwt\Exception\JwtConfigException;
use imeepo\Jwt\Exception\JwtTokenExpiredException;
...
class JwtToken
{
    ...
    {
        $config = config('plugin.imeepo.jwt.app.jwt');
        if (empty($config)) {
